...
- (void)clickBindingButton {
    ...
    [[NetworkTool sharedTool] parentChildBindingSaveWithChildCode:_childCode parentCode:_numberTextField.text finished:^(id  _Nullable result, NSError * _Nullable error) {
