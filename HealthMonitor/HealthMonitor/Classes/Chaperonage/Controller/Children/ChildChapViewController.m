...
@interface ChildChapViewController ()
@property(strong,nonatomic) UIView                *chooseLineView;
@property(strong,nonatomic) UIScrollView          *scrollView;

@end

@implementation ChildChapViewController
...
- (void)setupUI {
    ...
    ChildCurOrderViewController *childCurOrderViewController = [[ChildCurOrderViewController alloc] init];
    [self addChildViewController:childCurOrderViewController];
    childCurOrderViewController.view.frame = CGRectMake(0, 0, CGRectGetWidth(_scrollView.frame), CGRectGetHeight(_scrollView.frame));
    [_scrollView addSubview:childCurOrderViewController.view];
    
    ChildOrderListViewController *childOrderListViewController = [[ChildOrderListViewController alloc] init];
    [self addChildViewController:childOrderListViewController];
    childOrderListViewController.view.frame = CGRectMake(MainScreenWith, 0, CGRectGetWidth(_scrollView.frame), CGRectGetHeight(_scrollView.frame));
    [_scrollView addSubview:childOrderListViewController.view];
